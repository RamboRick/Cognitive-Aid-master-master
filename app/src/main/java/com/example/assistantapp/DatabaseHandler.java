...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static String createTabelQuery = "create table imageInfo (imageName TEXT" + ",image BLOB)";
    ...
    public void onCreate(SQLiteDatabase db) {
        try{
            ...
            Toast.makeText(context,"Table created succussfully inside our database",Toast.LENGTH_SHORT).show();
        }
        catch (Exception e)
        {
